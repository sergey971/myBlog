...
<div class="p-4 p-md-5 mb-4 text-white rounded bg-dark">
    <div class="col-md-6 px-0">
        <?php
        $query = $connect -> query("SELECT * FROM `articles` WHERE id = '21'");
        ...
        ?>
        <h2 class="display-5 font-italic"><?=$res['title'];?></h2>
        <p class="lead my-3"><p><?=$res['intro'];?></p>
        <p class="lead mb-0"><a href="/article.php?id=<?=$res['id']?>" class="text-white font-weight-bold">Продолжить чтение...</a></p>
        <?php endwhile?>
...
<div class="container ">
    <div class="row  float-right ">
        <aside class="p-4 p-md-5 mb-8 align-top"
        <div class="md-8 ">
...
<main class="container">
    <div class="row">
        <div class="col-md-10">
            ...
            ?>
            <?php
            if((int)$page > $length || $start = 0) $start = 0;
